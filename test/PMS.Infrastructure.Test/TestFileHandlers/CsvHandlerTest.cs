...
{     
    ...
    public void GetCsv_ValidCsvFile_ChecksContent()
    {
        ...
        // Test header
        Assert.Equal("id;sku;ean;name;description;color;material;product_type;product_group;supplier;supplier_sku;template_no;list;weight;currency;cost;price;special_price;platform", result[0]);
        // Test first product
        Assert.Equal("1;LC01-76-1038-1;EAN090909;iPhone 12 / 12 Pro cover - Black;A black iPhone 12 / 12 Pro cover;Black;Silicone / TPU;Cover;Smartphone;TVC;101123911A;12;457;0.1;DKK;5;99;79;shopify", result[1]);
